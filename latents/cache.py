        ...
        with tqdm(total=total_batches, desc="Caching latents") as pbar:
            for batch_number, batch in enumerate(token_batches):
                ...
                with torch.no_grad():
                    ...
                    # collect_activations() is renamed to activations and is used to get
                    # dictionaries of hookpoints and their corresponding activations
                    #
                    # those are model activations and not yet SAEs
                    with collect_activations(
                        ...
                        # collect activations of SAEs and cycle through all latents of all SAEs
                        for hookpoint, latents in activations.items():

                            # takes model activation and compute the SAE activation
                            sae_latents = self.hookpoint_to_sparse_encode[hookpoint](latents)
