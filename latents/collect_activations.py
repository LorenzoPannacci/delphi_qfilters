...
@contextmanager
def collect_activations(model: PreTrainedModel, hookpoints: list[str], transcode: bool = False):
    """
    ...
    def create_hook(hookpoint: str, transcode: bool = False):
        def hook_fn(module: nn.Module, input: Any, output: Tensor | tuple[Tensor]) -> Tensor | None:
